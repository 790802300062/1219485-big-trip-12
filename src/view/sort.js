...
const createSortTemplate = () => {
  ...
  const vehicleSymbol = (hasIcon) => {
    if (!hasIcon) {
      return ``;
    }

    return `<svg class="trip-sort__direction-icon" width="8" height="10" viewBox="0 0 8 10">
