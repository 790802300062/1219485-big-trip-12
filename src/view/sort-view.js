      ...
      `<form class="trip-events__trip-sort trip-sort" action="#" method="get">
        ...
        <div class="trip-sort__item trip-sort__item--event" data-sort-type="${SortType.DEFAULT}">
          <input id="sort-event" class="trip-sort__input visually-hidden" type="radio" name="trip-sort"
            value="sort-event" ${this._currentSortType === SortType.DEFAULT ? `checked` : ``}>
        ...
        <div class="trip-sort__item trip-sort__item--time" data-sort-type="${SortType.TIME}">
          <input id="sort-time" class="trip-sort__input visually-hidden" type="radio" name="trip-sort"
            value="sort-time" ${this._currentSortType === SortType.TIME ? `checked` : ``}>
        ...
        <div class="trip-sort__item trip-sort__item--price" data-sort-type="${SortType.PRICE}">
          <input id="sort-price" class="trip-sort__input visually-hidden" type="radio" name="trip-sort"
            value="sort-price" ${this._currentSortType === SortType.PRICE ? `checked` : ``}>
